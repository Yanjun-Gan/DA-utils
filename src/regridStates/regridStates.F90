...
! input
 ...
 do t = 1, n_tims
     do v = 1, n_vars
         if (localpet==0) print*,'** Setting up grids for grid_in'
         call setup_grid(localpet, npets, variable_list(v), grid_setup_in, grid_in)
...
! output
 ...
 do t = 1, n_tims
     do v = 1, n_vars
         if (localpet==0) print*,'** Setting up grids for grid_out'
         call setup_grid(localpet, npets, variable_list(v), grid_setup_out, grid_out)
 ...
 do t=1, n_tims
     do v=1, n_vars
        ...
        ! regrid the input fields to the output grid
         ...
         call ESMF_FieldRegridStore(srcField=fields_in(t,v), srcMaskValues=(/0/), &
                                    dstField=fields_out(t,v), dstMaskValues=(/0/), &
